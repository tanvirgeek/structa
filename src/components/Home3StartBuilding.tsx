  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center text-white flex flex-col items-center justify-center min-h-screen">
        <h6 className="text-white! mb-2">Do you have a project in mind?</h6>
        <h2 className="text-white!">Start Building With</h2>
        <h2 className="text-white!">Confidence Today</h2>
